        ...
        <form action="{{ route('admin.gejala.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input type="text" name="nama_gejala" value="{{ old('nama_gejala') }}"
                    placeholder="Contoh: Mual dan Muntah Berlebihan"
                    class="w-full px-4 py-2.5 border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500
            ...
            <div class="mb-5">
                ...
                <textarea name="keterangan" rows="3"
                    ...
                    class="w-full px-4 py-2.5 border border-gray-300 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none">{{ old('keterangan') }}</textarea>
            </div>
