...
<div class="max-w-2xl">
    <div class="bg-white border border-gray-200 rounded-xl">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
            <h2 class="text-sm font-semibold text-gray-900">Edit Informasi Gejala</h2>
            <span class="text-xs font-mono font-semibold text-blue-700 bg-blue-50 border border-blue-200 px-2.5 py-1 rounded">{{ $gejala->kode }}</span>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.gejala.update', $gejala->id) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="keterangan" rows="3"
                        class="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition">{{ old('keterangan', $gejala->keterangan) }}</textarea>
                </div>
