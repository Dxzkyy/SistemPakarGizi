...
<form action="{{ route('admin.hipotesis.update', $hipotesis->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white border border-gray-200 rounded-xl">
            <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100">
                ...
                <span class="text-xs font-mono font-semibold text-gray-700 bg-gray-100 border border-gray-200 px-2.5 py-1 rounded">{{ $hipotesis->kode }}</span>
            </div>
            <div class="p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="kode" value="{{ old('kode', $hipotesis->kode) }}"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama" value="{{ old('nama', $hipotesis->nama) }}"
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="3"
                        class="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition">{{ old('deskripsi', $hipotesis->deskripsi) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="rekomendasi" rows="5"
                        class="w-full px-3.5 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none transition">{{ old('rekomendasi', $hipotesis->rekomendasi) }}</textarea>
                </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl">
            ...
            <div class="p-4 overflow-y-auto max-h-[520px]">
                <div class="space-y-1.5">
                    ...
                    @php
                        $checked = $nilaiPakar->has($gejala->id);
                        $nilai   = $nilaiPakar->get($gejala->id);
                    @endphp
                    <div class="flex items-center gap-3 px-3 py-3 border rounded-lg transition
